...
-- D	=>  Location: PIN_25,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- C	=>  Location: PIN_24,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
...
-- Equation(s):
-- \Selector0~1_combout\ = (\estado_atual.S0~regout\ & (\estado_atual.S1~regout\ & ((\B~combout\)))) # (!\estado_atual.S0~regout\ & ((\A~combout\) # ((\estado_atual.S1~regout\ & \B~combout\))))
...
-- Equation(s):
-- \Selector0~0_combout\ = (\C~combout\ & ((\estado_atual.S2~regout\) # ((\estado_atual.S3~regout\ & \D~combout\)))) # (!\C~combout\ & (((\estado_atual.S3~regout\ & \D~combout\))))
